...
class _UpdateContactPageState extends State<UpdateContactPage> {
  ...
  void initState() {
    ...
    _fullNameController.text = _contact.fullname;
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: MyAppBar(title: "Modifier un contact",),
                  ...
                  ElevatedButton(
                    onPressed: () async {
                      if (_formKey.currentState!.validate()) {
                        ...
                        await _contactProvider.updateContact(_contact);
